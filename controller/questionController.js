...
const { categories } = require('../models/questionCategory');
...
exports.getAllQuestionBuyer = handler.getAll(QuestionBuyer);
...
exports.getAllQuestionCategory = handler.sendArry(categories);
...
exports.rejectAnswer = catchAsync(async (request, response, next) => {
  ...
  await question.rejectAnswer(reason, type);
  sendResponse({
