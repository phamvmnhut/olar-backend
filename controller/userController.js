...
const updateUserFunc = (type = 'common') => catchAsync(async (request, response, next) => {
...
exports.updateUser = updateUserFunc('admin');
...
exports.updateCoin = catchAsync(async (request, response, next) => {
  ...
  const isSuccess = await user.updateCoin({
    coin: parseInt(request.body.coin || 0, 10),
